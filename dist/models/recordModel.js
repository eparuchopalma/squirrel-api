...
const fundModel_1 = __importDefault(require("./fundModel"));
...
__decorate([
    (0, sequelize_typescript_1.ForeignKey)(() => fundModel_1.default),
    (0, sequelize_typescript_1.Column)({ allowNull: false }),
    __metadata("design:type", String)
...
__decorate([
    (0, sequelize_typescript_1.BelongsTo)(() => fundModel_1.default),
    __metadata("design:type", fundModel_1.default)
], Record.prototype, "fund", void 0);
__decorate([
    (0, sequelize_typescript_1.BelongsTo)(() => fundModel_1.default, 'correlated_fund_id'),
    __metadata("design:type", fundModel_1.default)
], Record.prototype, "correlatedFund", void 0);
Record = __decorate([
    (0, sequelize_typescript_1.Table)({ tableName: 'records', timestamps: false })
], Record);
